const androidSystemDesignData = {
    ...
    questions: [
        ...
        },
        {
            ...
            referenceLinks: [{ title: "WorkManager guide", url: "https://developer.android.com/topic/libraries/architecture/workmanager" }, { title: "HTTP Range requests — MDN", url: "https://developer.mozilla.org/en-US/docs/Web/HTTP/Range_requests" }],
        ...
        },
        {
            ...
            referenceLinks: [{ title: "Signal Protocol overview", url: "https://signal.org/docs/" }, { title: "WorkManager guide", url: "https://developer.android.com/topic/libraries/architecture/workmanager" }],
        ...
        },
        {
            ...
            referenceLinks: [{ title: "OkHttp Interceptors", url: "https://square.github.io/okhttp/features/interceptors/" }, { title: "Retrofit", url: "https://square.github.io/retrofit/" }],
        ...
        },
        {
            ...
            referenceLinks: [{ title: "Guide to app architecture", url: "https://developer.android.com/topic/architecture" }, { title: "WorkManager guide", url: "https://developer.android.com/topic/libraries/architecture/workmanager" }],
        ...
        },
        {
            ...
            referenceLinks: [{ title: "WorkManager guide", url: "https://developer.android.com/topic/libraries/architecture/workmanager" }, { title: "Firebase Analytics overview", url: "https://firebase.google.com/docs/analytics" }],
        ...
        },
        {
            ...
            referenceLinks: [{ title: "WorkManager guide", url: "https://developer.android.com/topic/libraries/architecture/workmanager" }, { title: "Monitor connectivity", url: "https://developer.android.com/training/monitoring-device-state/connectivity-status-type" }],
        ...
        },
        {
            ...
            referenceLinks: [{ title: "MessageDigest — Java docs", url: "https://docs.oracle.com/javase/8/docs/api/java/security/MessageDigest.html" }, { title: "Security with EncryptedSharedPreferences", url: "https://developer.android.com/topic/security/data" }],
        ...
        },
        {
            ...
            referenceLinks: [{ title: "Optimize for battery and data usage", url: "https://developer.android.com/topic/performance/power" }, { title: "ConnectivityManager", url: "https://developer.android.com/reference/android/net/ConnectivityManager" }],
        ...
        },
        {
            ...
            referenceLinks: [{ title: "OkHttp WebSocket", url: "https://square.github.io/okhttp/features/websockets/" }, { title: "Socket.IO docs", url: "https://socket.io/docs/v4/" }],
        ...
        },
        {
            ...
            referenceLinks: [{ title: "Cryptography — Android security", url: "https://developer.android.com/privacy-and-security/cryptography" }, { title: "TLS handshake overview", url: "https://developer.mozilla.org/en-US/docs/Web/Security/Transport_Layer_Security" }],
